...
private static void quizes() {
	System.out.println("Enter Student Name : ");
	Scanner scanner= new Scanner(System.in);
	String studentName =scanner.next();
	
	System.out.println(studentName + " Enter Your Choice.\n 1. Enter 1 for Java Quiz." +"\n 2. Enter 2 For Python Quiz." + "\n 3. Enter 3 For SQL Quiz."
			+ "\n 4. Enter 4 For EXit Quiz.");
